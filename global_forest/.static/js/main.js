...
const descriptionArray = [
    ...
    {"key":"아프리카에 살고 개발자인 아기사슴", "description": "당신은 넓은 평야에서 코딩하다 눈망울이 건조해져버린 아기사슴이군요!"},
    {"key":"아프리카에 살고 개발자인 너구리", "description": "당신은 사막에서 더위를 먹으며 개발하는 너구리군요!"},
    {"key":"아프리카에 살고 개발자인 부엉이", "description": "당신은 넓은 평야의 밤에 깨어나 코딩하는 부엉이군요!"},
    {"key":"아프리카에 살고 개발자인 고양이", "description": "당신은 피라미드 만들기 알고리즘 문제를 풀고 있는 스핑크스 고양이군요!"},
    
    {"key":"아프리카에 살고 예술가인 아기사슴", "description": "당신은 힙한 패션으로 많은 사람들의 주목을 받고 이집트 피라미드 앞에서 패션쇼를한 아기사슴이군요!"},
    {"key":"아프리카에 살고 예술가인 너구리", "description": "당신은 너구리굴을 아름답게 만드는 너구리굴 장인이군요."},
    {"key":"아프리카에 살고 예술가인 부엉이", "description": "당신은 밤길을 아름답게 비춰주는 넓은 평야의 부엉이군요."},
    {"key":"아프리카에 살고 예술가인 고양이", "description": "당신은 위대한 예술 작품을 만든 넓은 대륙에 한 번 나올까말까 한 감각적인 예술가 고양이군요!"},
    
    {"key":"아프리카에 살고 요리사인 아기사슴", "description": "당신은 넓은 대륙에서 잘생기긴 쉐프가 있기로 유명한 식당에서 대박난 아기사슴이군요!"},
    {"key":"아프리카에 살고 요리사인 너구리", "description": "당신은 어디에서나 삼시세끼 먹어도 질리지않는 까르보나라를 만드는 너구리군요!"},
    {"key":"아프리카에 살고 요리사인 부엉이", "description": "당신은 넓은 대륙을 돌아다니며 사람들에게 행복한 야식을 선사하는 쉐프 부엉이군요!"},
    {"key":"아프리카에 살고 요리사인 고양이", "description": "당신은 넓은 대륙의 동물 친구들이 맛잘알로 임명한 요리장인 고양이군요."},

    {"key":"아프리카에 살고 마법사인 아기사슴", "description": "당신은 넓은 대륙에서 사람들의 예쁜 얼굴을 책임지는 성형마법을 구사하는 멋진 아기사슴이군요!"},
    {"key":"아프리카에 살고 마법사인 너구리", "description": "당신은 덩치가 커질 수 있는 묘기를 부릴 수 있는 넓은 대륙의 너구리입니다!"},
    {"key":"아프리카에 살고 마법사인 부엉이", "description": "당신은 밤이되면 밝은 빛을 내는 달을 소환할 수 있는 특별한 능력을 가진 부엉이군요!"},
    {"key":"아프리카에 살고 마법사인 고양이", "description": "당신은 넓은 대륙을 순간이동할 마법으로 이동할 수 있는 빠르고 날렵한 고양이군요!"},
    
    {"key":"아메리카에 살고 개발자인 아기사슴", "description": "당신은 자유롭고 싶지만 회사에서 일을 해야하는 불쌍한 아기사슴이군요!"},
    {"key":"아메리카에 살고 개발자인 너구리", "description": "당신은 야근을 달고 살며 다크서클이 생긴 아메리카 대륙의 도시 너구리군요!"},
    {"key":"아메리카에 살고 개발자인 부엉이", "description": "당신은 Forbes 100대 기업에서 고연봉을 받는 부엉이군요! "},
    {"key":"아메리카에 살고 개발자인 고양이", "description": "당신은 실리콘 밸리에서 억대연봉을 받는 백엔드 개발자 고양이군요!"},

    {"key":"아메리카에 살고 예술가인 아기사슴", "description": "당신이 그림그리길 좋아하는 겨울왕국 스벤 아들 친구 아기사슴이군요!"},
    {"key":"아메리카에 살고 예술가인 너구리", "description": "당신은 다크서클의 힘으로 예술을 하는 너구리군요!"},
    {"key":"아메리카에 살고 예술가인 부엉이", "description": "당신은 미국산 BOO가 틀림없군요! "},
    {"key":"아메리카에 살고 예술가인 고양이", "description": "당신은 일이 취미인 성공한 예술가 고양이군요!"},
    
    {"key":"아메리카에 살고 요리사인 아기사슴", "description": "당신은 3개의 미슐랭 스타를 받은 마스터 셰프 US에서 1등을 한 사슴이군요!"},
    {"key":"아메리카에 살고 요리사인 너구리", "description": "당신은 미국 66번 국도에서 카마로를 몰고 있는 마스터 셰프 너구리군요!"},
    {"key":"아메리카에 살고 요리사인 부엉이", "description": "당신은 식당이 너무 잘되어 돈쭐이 나고 있는 부엉이군요!"},
    {"key":"아메리카에 살고 요리사인 고양이", "description": "당신은 츄르를 직접 만들어 먹길 좋아하는 뚱땡이 고양이군요!"},
    
    {"key":"아메리카에 살고 마법사인 아기사슴", "description": "당신은 자유롭게 넓은 곳에서 뛰놀며 머글들 몰래 마법을 부리는 아기사슴이군요."},
    {"key":"아메리카에 살고 마법사인 너구리", "description": "당신은 어떤 주문이든 외워버리는 너구리군요."},
    {"key":"아메리카에 살고 마법사인 부엉이", "description": "당신은 아메리카의 넓은 곳을 투시하는 마법을 가진 부엉이군요!"},
    {"key":"아메리카에 살고 마법사인 고양이", "description": "당신은 남들이 잘 모르는 새로운 주술을 외우는 자유로운 고양이군요!"},
